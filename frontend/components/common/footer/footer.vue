                ...
                <div class="col-lg-3 col-md-6">
                    ...
                    <div class="about-payment footer-contant">
                        ...
                        <p>
                            ...
                            simply random text. It has roots in a piece Lorem
                            fugit on looked ipsum.
                        </p>
                        <ul class="social-group">
                            <li>
                                <a
                                    class="icon-btn btn-google button-effect btn-sm"
                    ...
                    <div class="links">
                        ...
                        <div class="footer-contant">
                            <ul>
                                ...
                                <li>
                                    <nuxt-link to="/bonus/faq">FAQ</nuxt-link>
                                </li>
                                <li>
                        ...
                        <div>
                            ...
                            <div class="footer-contant">
                                <div class="footer-btn">
                                    <a
                                        class="btn active"
                                        href="https://www.apple.com/in/itunes/"
        ...
        <div class="container copyright-footer">
            <!-- <div class="row copyright">
                <div class="col-md-6 col-sm-12">
                    <p class="footer-left">
                        © 2021 Chitchat. All Rights Reserved
                    </p>
                </div>
