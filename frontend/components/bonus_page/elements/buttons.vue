            ...
            >
              <div
                ...
                :style="[
                  {
                    'background-image':
                      'url(' + this.getImgUrl('avtar/big/audiocall.jpg') + ')',
                  },
                  styleObject,
                ]"
              >
                  ...
                  <ul>
                    ...
                    <li>
                      <a
                        ...
                        @click="$bvModal.hide('audiorcvcall')"
                        href="javascript:void(0)"
                  ...
                  <div class="usersprof">
                    <div
                      ...
                      :style="[
                        {
                          'background-image':
                            'url(' + this.getImgUrl('avtar/2.jpg') + ')',
                        },
                        styleObject,
                      ]"
                    ></div>
                    <div
                      ...
                      :style="[
                        {
                          'background-image':
                            'url(' + this.getImgUrl('avtar/3.jpg') + ')',
                        },
                        styleObject,
                      ]"
                    ></div>
                    <div
                      ...
                      :style="[
                        {
                          'background-image':
                            'url(' + this.getImgUrl('avtar/5.jpg') + ')',
                        },
                        styleObject,
                      ]"
                    ></div>
                      ...
                      :style="[
                        {
                          'background-image':
                            'url(' +
                            this.getImgUrl('avtar/big/videocall_bg.jpg') +
                            ')',
                        },
                        styleObject,
                      ]"
              ...
              <div class="no-internet animat-rate">
                ...
                <div class="quarterCircle">
                  <div
                    class="close-btn"
                    data-dismiss="modal"
                    @click="$bvModal.hide('nointernetmodal')"
                  >
                  ...
                  :style="[
                    {
                      'background-image':
                        'url(' +
                        this.getImgUrl('avtar/big/videocall.jpg') +
                        ')',
                    },
                    styleObject,
                  ]"
                ...
                <div class="center-con text-center">
                  <ul>
                    <li>
                      <a
                        class="icon-btn btn-success button-effect btn-xl is-animating"
                        @click="$bvModal.hide('videocallhang')"
                        href="javascript:void(0)"
                        ><feather type="video"></feather
                      ></a>
                    </li>
                    ...
                    :style="[
                      {
                        'background-image':
                          'url(' +
                          getImgUrl('avtar/big/videocall_bg.jpg') +
                          ')',
                      },
                      styleObject,
                    ]"
                ...
                <ul>
                  <li>
                    <a
                      ...
                      href="javascript:void(0)"
                      data-tippy-content="speaker"
                      ><feather type="volume-2" size="15" height="15"></feather
                    ></a>
                  </li>
                  <li>
                    <a
                  ...
                  <li>
                    <a
                      ...
                      @click="$bvModal.hide('confvideocl')"
                      href="javascript:void(0)"
                      data-dismiss="modal"
                      data-tippy-content="Hangup"
                  ...
                  <li>
                    <a
                      ...
                      href="javascript:void(0)"
                      data-tippy-content="Disable Video"
                      ><feather type="video-off" size="15" height="15"></feather
                    ></a>
                  </li>
                  <li>
                    <a
                      ...
                      href="javascript:void(0)"
                      data-tippy-content="Mute"
                      ><feather type="mic-off" size="15" height="15"></feather
                    ></a>
                  </li>
                  <li>
                    <a
