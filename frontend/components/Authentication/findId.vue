  ...
  <div class="login-page2 animat-rate">
    <div class="login-content-main">
      ...
      <div class="login-content">
        ...
        <h3 v-if="! isIdfind" class="mt-3" style="text-align:left">아이디 찾기</h3>
        ...
        <form class="form2">
          ...
          <div v-if="isIdfind" style="height:20px"></div>
          <div v-if="isIdfind">
            <h3>회원님의 아이디는 <a style="color:blue"> {{this.userId}} </a> 입니다.</h3>
          </div>
          <div v-if="! isIdfind" class="form-group mb-0">
            <div class="buttons">
              <a class="btn button-effect btn-primary btn-block" @click="findId"
                >아이디 찾기</a
              >
            </div>
          </div>
    ...
    findId() {
      http
        ...
        .catch((error) => {
          ...
          this.$alertify.error("등록된 아이디가 없습니다.");
        });
    }
