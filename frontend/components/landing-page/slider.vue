          ...
          <div class="col-12">
            <div class="slider-main">
              <div class="slider-contain">
                ...
                <h4>
                  <span>진료 시작 15분 전부터 입장 가능합니다 </span>
                </h4>
                <div class="downlaod">
          ...
          .then(({ data }) => {
            ...
            for (var i = 0; i < data.confirmList.length; i++) {
              ...
              if (elapsedMin <= 5 && elapsedMin >= 0) {
                ...
                this.$store.state.login.sessionId =
                  data.confirmList[i].user.userId; // oauth랑 auth구별해서 해야되는디...

                this.$store.state.login.mydoctor =
                  data.confirmList[i].doctorInfo.user.name;
