  ...
  <div id="main-container" class="container">
    ...
    <div id="session" v-if="session" style="heigh: 100%; display: inline">
      ...
      >
        ...
        <div
          id="video-container"
          style="height: 400px; width: 400px; paddding-right: 20px"
        >
          <user-video
...
export default {
  ...
  methods: {
    ...
    onChange(event) {
      ...
      this.mySessionId =
        "ch-session-sixman-" + this.charToUnicode(this.$data.patientName);
      this.chatChannel =
        "ch-chat-sixman-" + this.charToUnicode(this.$data.patientName);
    },
    async asyncfunction() {
      this.isLoading = true;
      this.preJoin();
